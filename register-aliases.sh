...
alias claudepilot-start='$aliases/claudepilot-start.sh'
alias claudepilot='$aliases/claudepilot.sh $*'
# Backwards-compatible alias: start the claude MCP server + CLI wrapper
...
alias check-ram-usage='$aliases/check-ram-usage.sh $1'
alias choco-list='$aliases/choco-list.sh $*'
alias choco-install='$aliases/choco-install.sh $*'
alias choco-uninstall='$aliases/choco-uninstall.sh $*'
alias convert-path='$aliases/convert-path.sh'
alias compress='$aliases/compress.sh $*'
alias create-project.python='$aliases/create-project.python.sh $*'
alias create-project.cymatic='$aliases/create-project.cymatic.sh $*'
alias create-project.maven='$aliases/create-project.maven.sh $*'
alias create-project.mixcraft='$aliases/create-project.mixcraft.sh $*'
alias create-project.js='$aliases/create-project.js.sh $*'
alias create-project.jekyll='$aliases/create-project.jekyll.sh $*'
alias create-project.reveal='$aliases/create-project.reveal.sh $*'
alias create-project.spring='$aliases/create-project.spring.sh $*'
alias create-project.spring-monolith='$aliases/create-project.spring-monolith.sh $*'
...
alias enumerate-files-in-directory='$aliases/enumerate-files-in-directory.sh'
...
alias git-init.cymatic='$aliases/git-init.cymatic.sh $*'
...
alias kill-mixcraft='$aliases/kill-mixcraft.sh'
...
alias new-mixcraft-project='$aliases/new-mixcraft-project.sh $1'
...
alias restart-mixcraft='$aliases/restart-mixcraft.sh'
alias restart-process='$aliases/restart-process.sh'
alias imscc2md='$aliases/imscc2md.sh "$@"'
alias md2imscc='$aliases/md2imscc.sh "$@"'
alias stems='$aliases/stems.sh "$@"'
alias toggle-clock='$aliases/toggle-clock.sh'
alias upscale='$aliases/upscale.sh "$@"'
