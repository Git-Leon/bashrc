...
apply_canvas() {
  case "$1" in
    portrait)  MW=1080; MH=1350; TAG="upscaled.portrait" ;;
    square)    MW=1080; MH=1080; TAG="upscaled.square"  ;;
    landscape) MW=1080; MH=566;  TAG="upscaled.landscape"  ;;
    *)         MW=1080; MH=1350; TAG="upscaled" ;;
  esac
}
