...
$killScript "ApsInsSvc.exe"
$killScript "EasyResume.exe"
$killScript "Lenovo.Modern.ImController.exe"
$killScript "Lenovo.Modern.ImController.PluginHost.exe"
$killScript "Lenovo.Modern.ImController.PluginHost.Device.exe"
